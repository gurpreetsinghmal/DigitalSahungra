    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                int webversion=Integer.parseInt(dataSnapshot.getValue(String.class));
                Log.d("versioncode", "appversion-"+appversion+"-webversion-"+webversion);
...
//                        }
       ...
       // blogs=new blogs();
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.mycontainer,new recents_updates()).commit();
        }
        ...
        positivebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Uri marketUri = Uri.parse("https://play.google.com/store/apps/details?id=com.technominds.digitalsahungrav2");
